...
import { HeartIcon, HomeIcon, MagnifyingGlassIcon, PlusIcon, QueueListIcon } from '@heroicons/react/24/solid'
        ...
        <div className='w-64 h-screen grow-0 shrink-0 border-r border-neutral-900 flex flex-col p-5 space-y-4 text-neutral-400 text-sm hidden md:inline-flex'>
            ...
            <div className='hover:text-white'>
                <button
                    ...
                    className={`flex items-center space-x-2 ${view == 'search' ? 'text-white' : null}`}
                >
            ...
            <div className='hover:text-white'>
                <button
                    ...
                    className={`flex items-center space-x-2 ${view == 'library' ? 'text-white' : null}`}
                >
